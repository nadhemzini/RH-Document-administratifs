    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                <img src="/layout/images/ISIM_LOGO_ar-removebg-preview.png" alt="Sakai logo" className="mb-5 w-6rem flex-shrink-0" />
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <Link href="/dashboard" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                        ...
                        <Link href="/dashboard" className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
